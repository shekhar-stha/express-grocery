    ...
    return (
        <section id="about" className="about-us container">
            <div className="row flex-row-reverse gap-lg-5">
                <div data-aos="fade-left" className="col-lg mb-lg-0 mb-5 info-side">
                    ...
                    <div className="d-sm-flex">
                        ...
                        <a href="/contact" className="icon-div ms-sm-5 mt-sm-0 mt-3">
                ...
                <div data-aos="fade-right" className="col-lg img-side">
                    <img src="/img/store-indoor.JPG" alt="AC Outside" />
